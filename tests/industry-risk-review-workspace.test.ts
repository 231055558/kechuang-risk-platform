...
test("industry workspace leads with customer conclusions and preserves auditable detail", () => {
  ...
  assert.match(graphSource, /industry-graph-stage-rail/)
  assert.match(graphSource, /industry-graph-inspector-empty/)
  assert.match(graphSource, /useState<IndustryRiskGraphView>\("focus"\)/)
